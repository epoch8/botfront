...
export const getFragmentsAndDomain = async (projectId, language, env = 'development') => {
    ...
    const processedFragments = fragmentsWithCheckpoints.map((fragment) => {
    ...
    domain.actions_params = parametrizedActions;

    return {
        stories: processedFragments
